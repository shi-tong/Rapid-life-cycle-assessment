...
prediction_file_path = os.path.join(current_dir, 'predictions_lightgbm.xlsx')
...
plt.legend()
plt.grid(True)
plt.savefig(os.path.join(save_dir, 'LCA_prediction_vs_test_lightgbm.png'), dpi=300)  
plt.show()
